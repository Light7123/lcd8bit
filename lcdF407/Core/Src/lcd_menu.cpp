...
Row* menu = new Row({"root"});
Row* wait1 = new Row({"root"});
Row* naliv1 = new Row({"root"});
Row* otmena1 = new Row({"root"});
Row* oplata1 = new Row({"root"});
Row* vozvrat1 = new Row({"root"});
int str[80][14] = {
...
{172, 165, 173, 238, 232, 170, 168, 300},
{119, 97, 105, 116, 300},
{110, 97, 108, 105, 118, 300},
{111, 116, 109, 101, 110, 97, 300},
{111, 112, 108, 97, 116, 97, 300},
{118, 111, 122, 118, 114, 97, 116, 300}
};
void menu_init()
{
	//������������������������������������������������������ ������������������������
	...
	start_menu->addRow({"menu",72})->children.push_back(menu);
	...
	setting_menu->addRow({"plat rashire",20})->children.push_back(setting_rashir);
		...
		setting_rashir->addRow({"zamena",61})->children.push_back(zamena);
			...
			zamena->addRow({"data",65})->children.push_back(data_zamen);
				...
				menu->parent=start_menu;
		menu->addRow({"wait",73})->children.push_back(wait1);
			wait1->addRow({"wait",73,NULL,NULL,nal_menu,zero_buttons,NULL,menu1_ptr})->parent=menu;
		menu->addRow({"naliv",74})->children.push_back(naliv1);
			naliv1->addRow({"naliv",74,NULL,NULL,nal_menu,zero_buttons,NULL,menu2_ptr})->parent=menu;
		menu->addRow({"otmena",75})->children.push_back(otmena1);
			otmena1->addRow({"otmena",75,NULL,NULL,nal_menu,zero_buttons,NULL,menu3_ptr})->parent=menu;
		menu->addRow({"oplata",76})->children.push_back(oplata1);
			oplata1->addRow({"oplata",76,NULL,NULL,nal_menu,zero_buttons,NULL,menu4_ptr})->parent=menu;
		menu->addRow({"vozvrat",77})->children.push_back(vozvrat1);
			vozvrat1->addRow({"vozvrat",77,NULL,NULL,nal_menu,zero_buttons,NULL,menu5_ptr})->parent=menu;
