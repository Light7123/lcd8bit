{142, 231, 168, 225, 226, 170, 160, 47, 161, 160, 170, 300},
{145, 226, 160, 226, 227, 225, 300},
{144, 160, 225, 229, 174, 164, 172, 165, 224, 300},
{142, 161, 234, 165, 172, 32, 49, 300},
{142, 161, 234, 165, 172, 32, 50, 300},
{142, 161, 234, 165, 172, 32, 51, 300},
{142, 161, 234, 165, 172, 300},
{150, 165, 173, 160, 300},
{142, 161, 234, 165, 172, 32, 49, 300},
{142, 161, 234, 165, 172, 32, 50, 300},
{142, 161, 234, 165, 172, 32, 51, 300},
...
{142, 161, 234, 165, 172, 32, 51, 300},
{138, 227, 175, 238, 224, 174, 175, 224, 168, 165, 172, 300},
{136, 173, 170, 32, 225, 173, 239, 226, 32, 225, 226, 165, 170, 300},
{142, 231, 168, 225, 226, 170, 160, 47, 161, 160, 170, 300},
{144, 165, 166, 168, 172, 32, 224, 160, 161, 174, 226, 235, 300},
{135, 160, 175, 224, 160, 162, 47, 167, 160, 172, 165, 173, 160, 300},
{132, 160, 226, 160, 32, 167, 160, 175, 224, 160, 162, 170, 168, 300},
{130, 224, 227, 231, 173, 227, 238, 300},
{128, 162, 226, 174, 172, 160, 226, 168, 231, 165, 225, 170, 168, 300},
{132, 160, 226, 160, 32, 167, 160, 172, 165, 173, 235, 300},
{130, 224, 227, 231, 173, 227, 238, 300},
{128, 162, 226, 174, 172, 160, 226, 168, 231, 165, 225, 170, 168, 300}
};
void menu_init()
{
	...
	setting_menu->addRow({"kalibrovka",16})->children.push_back(kalibrovka);
		kalibrovka->addRow({"rashod",45})->parent=setting_menu;
	setting_menu->addRow({"ustirovka",17})->children.push_back(ustirowka);
		ustirowka->addRow({"obem 1",46})->parent=setting_menu;
		ustirowka->addRow({"obem 2",47})->parent=setting_menu;
		ustirowka->addRow({"obem 3",48})->parent=setting_menu;
	setting_menu->addRow({"price",18})->children.push_back(price);
		...
		price->addRow({"obem",49})->children.push_back(price_obem);
			price_obem->addRow({"obem 1",51})->parent=price;
			price_obem->addRow({"obem 2",52})->parent=price;
			price_obem->addRow({"obem 3",53})->parent=price;
		price->addRow({"cena",50})->children.push_back(price_cena);
			price_cena->addRow({"obem 1",54})->parent=price;
			price_cena->addRow({"obem 2",55})->parent=price;
			price_cena->addRow({"obem 3",56})->parent=price;
	setting_menu->addRow({"nichnie",19})->children.push_back(setting_nal);
		...
		setting_nal->addRow({"kupur",57})->children.push_back(setting_kupur);
			setting_kupur->addRow({"inkas",58})->parent=nal_stat;
